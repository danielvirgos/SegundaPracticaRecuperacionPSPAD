...
import com.example.aplicacionamigosrecuperacion.view.recyclerviewadapter.UpdateRecyclerViewAdapter;
...
public class UpdateFragment extends Fragment {
    ...
    private void init(View view) {
        ...
        UpdateRecyclerViewAdapter amigosRecyclerViewAdapter = new UpdateRecyclerViewAdapter(amigos, getContext(), view);
